        ...
        <div>
          <div className="flex ml-20 mt-10">
            ...
            <div className="flex flex-col ml-20 mt-4 gap-4">
              ...
              {currentUserId !== userId && (
                <div className="flex">
                  <button onClick={handleFollow} className="mx-4 py-1.5 bg-orange-300 rounded-3xl w-20">{isFollowing ? 'Unfollow' : 'Follow'}</button>
                  <button onClick={handleMessaging} className="py-1.5 bg-orange-300 rounded-3xl w-20">Message</button>
                </div>
              )}
            </div>
          </div>
